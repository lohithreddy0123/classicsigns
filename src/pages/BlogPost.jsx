  ...
  return (
    <>
      <Helmet>
        ...
        <link rel="canonical" href={`https://www.classicporcelainsigns.com/blogs/${blog.slug}`} />
        <meta property="og:title" content={blog.title} />
        <meta property="og:description" content={blog.description} />
        <meta property="og:type" content="article" />
        <meta property="og:url" content={`https://www.classicporcelainsigns.com/blogs/${blog.slug}`} />
      </Helmet>
      <div className="blogpost-page">
        <div className="blogpost-container">
          <Link to="/blogs" className="back-btn">← Back to Blogs</Link>
          ...
          <div className="post-cover-wrap">
            <img src={blog.image} alt={blog.title} className="post-cover" loading="lazy" />
          </div>
          ...
          <div className="post-footer">
            <Link to="/blogs" className="back-btn-bottom">← Back to all blogs</Link>
          </div>
        </div>
      </div>
    </>
